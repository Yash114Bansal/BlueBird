...
# Configure Alembic to only manage auth tables
def include_object(object, name, type_, reflected, compare_to):
    """Filter objects to only include auth tables."""
    if type_ == "table":
        # Only include tables that are defined in our user models
        # Get table names from our Base metadata
        auth_table_names = set(target_metadata.tables.keys())
        return name in auth_table_names
    return True
